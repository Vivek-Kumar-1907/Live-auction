...
export async function POST(request: Request) {
  ...
  const auctionlength = Number(formData.get("auctionLength"));
  ...
  await pool.query(
    "INSERT INTO items (title, description, starting_bid, image_url, user_id, auctionLength) VALUES ($1, $2, $3, $4, $5, $6)",
    [title, description, price, imageUrl, userId, auctionlength]
  );
